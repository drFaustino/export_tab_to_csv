...
# Libreria necessaria da aggiungere per dialogare con QGIS
...
class ExportTabToCSV:
    ...
    def add_action(
        ...
        # rigra per personalizzare l'icona
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&Esporta Tab su file CSV'),
                action)
    ...
    def run(self):
        ...
        if result:
            ...
            "Successo", "Il file CSV e' stato scritto correttamente in " + filename,
